  ...
  Certificates: [
    {
      ...
      link: "certificates/CCNA: Introduction to Networks.jpg",
      year: "2026",
    },
    {
      ...
      link: "certificates/AI Fluency.jpg",
      year: "2026",
    },
    {
      title: "Introduction to Cyber Security",
      issuer: "CISCO",
      image: "certificates/Introduction to Cyber Security CISCO.jpg",
      link: "certificates/Introduction to Cyber Security CISCO.jpg",
      year: "2026",
    },
    {
      title: "AWS Cloud Fundamental Essentials",
      issuer: "AWS",
      image: "certificates/AWS Cloud Certificates.jpg",
      link: "certificates/AWS Cloud Certificates.jpg",
      year: "2026",
    },
    {
      ...
      link: "certificates/HCL GUVI Certification.png",
      year: "2026",
    },
    {
      ...
      link: "certificates/Introduction to AI.jpg",
      year: "2025",
    },
    {
      ...
      link: "certificates/python cisco.jpg",
      year: "2025",
    },
    {
      title: "Google Solution Challenge",
      issuer: "Google",
      image: "certificates/Solution Challenge.jpg",
      link: "certificates/Solution Challenge.jpg",
      year: "2025",
    },
    {
      title: "Deloite Data Analytics Job Simulation",
      issuer: "Deloite",
      image: "certificates/Deloite Data Analytics.jpg",
      link: "certificates/Deloite Data Analytics.jpg",
      year: "2025",
    },
    {
    ...
    },
    {
      ...
      image: "certificates/Infosys HTML.jpg",
      link: "certificates/Infosys HTML.jpg",
      year: "2023",
    },
    {
      title: "Samadhan 1.0 Hackathon",
      issuer: "SISTec Bhopal",
      image: "certificates/Samadhan 1.0.jpg",
      link: "certificates/Samadhan 1.0.jpg",
      year: "2024",
    },
    {
      title: "CSS3 Advanced Styling",
      issuer: "Infosys Springboard",
      image: "certificates/Infosys CSS.jpg",
      link: "certificates/Infosys CSS.jpg",
      year: "2024",
    },
    {
      title: "Hands-on IoT: From Sensors to Cloud",
      issuer: "SISTec IoT Club",
    ...
    },
    {
      ...
      issuer: "Infosys Springboard",
      image: "certificates/Infosys JS.jpg",
      link: "certificates/Infosys JS.jpg",
      year: "2024",
    },
    {
      title: "Frontend Development",
      issuer: "Infosys Springboard",
      image: "certificates/Infosys Frontend.jpg",
      link: "certificates/Infosys Frontend.jpg",
      year: "2024",
    },
    {
      title: "Frontend Development",
      issuer: "Great Learning",
      image: "certificates/Great Learning.jpg",
      link: "certificates/Great Learning.jpg",
      year: "2024",
    },
    {
      title: "Artificial Intelligence",
      issuer: "AI Builder Lab",
      image: "certificates/AI Builder Lab.jpg",
      link: "certificates/AI Builder Lab.jpg",
      year: "2025",
    },
    {
      title: "Git and GitHub",
      issuer: "Microsoft Learn Student Ambassador",
      image: "certificates/Git and Github.jpg",
      link: "certificates/Git and Github.jpg",
      year: "2024",
    },
  ],
...
const Credentials = () => {
   ...
   *
   * Behavior:
   * 1. While the inner list has content to scroll -> only list scrolls.
   * 2. At the bottom + user scrolls down -> event passes to website.
   * 3. At the top + user scrolls up -> event passes to website.
   *
   * This avoids trapping the page at the beginning/end of
  ...
  const handleWheel = (e) => {
    ...
    // Still scrolling inside the list:
    // prevent the wheel event from reaching the outer smooth-scroll/page.
    if (
    ...
    // At top scrolling upward OR at bottom scrolling downward:
    // DO NOT stop propagation.
    // The wheel event reaches the main website and page scrolling continues.
  };

  return (
    <section
      className="relative w-full bg-[#050505] py-24 md:py-32 overflow-hidden font-sans"
      id="Credentials"
    >
      {/* STATIC BACKGROUND */}
      ...
      <div className="max-w-[1300px] mx-auto relative z-10 px-4 md:px-8">
        ...
        <div className="relative w-full flex items-center justify-center py-10 mb-12 md:mb-20">
          <h2
            className="absolute text-[13vw] md:text-[11vw] font-black uppercase tracking-tighter text-transparent select-none opacity-20"
            style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center gap-4">
                      ...
                      <h4
                        className={`text-lg md:text-xl font-bold transition-colors duration-300 line-clamp-2 ${
                          isActive
                            ? "text-white"
                      ...
                      <div
                        className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 transform-gpu ${
                          isActive
                            ? "bg-white text-black rotate-90 lg:rotate-0"
                            : "bg-white/5 text-gray-500 group-hover:bg-white/10 group-hover:text-white -rotate-45"
                        }`}
                      >
                        <ArrowRight size={16} />
                      </div>
          ...
          {/* RIGHT: STICKY SPOTLIGHT - DESKTOP */}
